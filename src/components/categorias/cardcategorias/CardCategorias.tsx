  ...
  function CardCategorias({categoria}: CardCategoriaProps) {
    return (
      <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
        ...
        <p className='p-8 text-3xl bg-slate-200 h-full'>{categoria.marca}</p>
        <div className="flex">
          <Link to={`/editarCategoria/${categoria.id}`} className='w-full text-slate-100 bg-green-500 hover:bg-green-700 flex items-center justify-center py-2'>
